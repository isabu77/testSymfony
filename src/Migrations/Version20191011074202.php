 ...
 */
final class Version20191011074202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_likes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, article_id INTEGER DEFAULT NULL, users_id INTEGER DEFAULT NULL)');
        $this->addSql('CREATE INDEX IDX_3E7D3C6C7294869C ON article_likes (article_id)');
        $this->addSql('CREATE INDEX IDX_3E7D3C6C67B3B43D ON article_likes (users_id)');
        $this->addSql('DROP INDEX IDX_23A0E6612469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, category_id, title, content, image, created_at, price FROM article');
        ...
        $this->addSql('INSERT INTO article (id, category_id, title, content, image, created_at, price) SELECT id, category_id, title, content, image, created_at, price FROM __temp__article');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, category_id, title, content, image, created_at, price FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, price DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO article (id, category_id, title, content, image, created_at, price) SELECT id, category_id, title, content, image, created_at, price FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E6612469DE2 ON article (category_id)');
        $this->addSql('DROP INDEX IDX_9474526C7294869C');
